...
FAQS = [
    {
        "question": "What is VideoBolt Online video downloader?",
        "answer": "VideoBolt is an online video downloader that allows you to download and save all videos from video services and social networks with the highest quality for free."
    },
    {
        "question": "How to download and save videos online and free?",
        "answer": "If you are also looking for a way to download videos like TikTok, Pinterest, Likee, Instagram, etc., just copy the video URL in GiveFastLink, then download and save the video in less than a few seconds."
    },
    {
        "question": "What social and websites are supporting in VideoBolt downloader?",
        "answer": "More than 50 video services and social networks are supported in VideoBolt, and it is almost all socials in the world, and this number is increasing every day."
    },
    {
        "question": "Does it free to download and save videos from VideoBolt ?",
        "answer": "Absolutely yes. You can use our downloading service 100% free and unlimited."
    },
    {
        "question": "Where are videos going after being downloaded?",
        "answer": "All videos are saved in the “Downloads” folder on almost all devices like Android, iOS, iPhone/iPad, Windows, and Mac."
    },
    {
        "question": "What file formats can I download videos from VideoBolt ?",
    ...
    {
        "question": "Can I watch the downloaded videos offline mode?",
        "answer": "Yes, of course. You can watch the videos after downloading them from your gallery or “Downloads” folder."
    },
    {
        "question": "What quality of the video will I get after I download it from VideoBolt ?",
    ...
    {
        "question": "Is downloading from the VideoBolt legal and is not copyright infringing?",
        "answer": "VideoBolt doesn't host pirated, or copyright content on its server, and all videos or images that you download from our tool are downloaded from their respective CDN servers. So our tool has no control over the subject of the videos."
    },
    {
        "question": "What device can I use to download a social video using the VideoBolt tool?",
        "answer": "Use any device you like! The VideoBolt social video downloader is compatible with all devices and OS – from Android to IOS, from Windows to Mac, Samsung to iPhone, Xiaomi, and Huawei."
    },
    {
        "question": "Is it secure to use VideoBolt for downloading online videos?",
        "answer": "Yes, VideoBolt is a completely secure web app for downloading videos. We provide security and privacy for our users."
    }
]
